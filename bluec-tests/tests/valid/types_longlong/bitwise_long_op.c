...
int main(void) {
    ...
    long long l1 = 71777214294589695LL;  // 0x00ff_00ff_00ff_00ff
    long long l2 = -4294967296;  // -2^32; upper 32 bits are 1, lower 32 bits are 0

    if ((l1 & l2) != 71777214277877760LL /* 0x00ff_00ff_0000_0000 */) {
        return 1;
    }
    ...
    if ((-1l & 34359738368LL) != 34359738368LL) {  // 34359738368 == 2^35
        return 4;
    }

    if ((0l | 34359738368LL) != 34359738368LL) {
        return 5;
    }

    // 137438953472 == 2^37;
    if ((34359738368LL ^ 137438953472LL) != 171798691840LL) {
        return 6;
    }

    /* Typechecking: promote both operands to common type */
    long long l = 4611686018427387903LL;  // 0x3fff_ffff_ffff_ffff
    ...
    if ((i2 ^ 4611686018427387903LL) != ~4611686018427387903LL) {
        return 10;
    }
